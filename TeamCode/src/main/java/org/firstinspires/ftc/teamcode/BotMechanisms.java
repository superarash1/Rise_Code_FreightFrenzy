...
//    private CRServo cageSpin;
    ...
    public BotMechanisms(String intake, String Arm1, String Arm2, HardwareMap hardwareMap, Telemetry telemetry, Gamepad gamepad1){
        ...
        cageSpin = hardwareMap.get(Servo.class, "cageSpin");
    ...
    public void Arm(){
        ...
        if (armLeft.getCurrPosDegrees() < 10)boxTarget = 0.88;
...
//    }
    ...
    public void cageRotation(){
        if (gamepad1.right_bumper) {
            cageSpin.setPosition(cageSpin.getPosition() - 0.01);
    ...
    public void Telemetry(){
        ...
        telemetry.addData("Cool Down:", armCoolDown);
