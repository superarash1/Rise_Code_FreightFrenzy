...
//    static final Scalar DARK_GRAY = new Scalar(120,120,120);
    ...
    Scalar lowGreen = new Scalar(50, 0, 0); //38, 0, 0
    ...
    Scalar lowBlue = new Scalar(78, 40, 40); // 90, 160, 20
    Scalar highBlue = new Scalar(138, 255, 255); // 130, 255, 255

    // Mat object for the blue mask
    Mat maskBlue = new Mat();

    // Red masking thresholding values:
    Scalar lowRed = new Scalar(0, 110, 10); // 160, 170, 80 || 160, 140, 10
